...
// mockArmResourcesListPager is an autogenerated mock type for the armResourcesListPager type
type mockArmResourcesListPager struct {
	mock.Mock
}

// Err provides a mock function with given fields:
func (_m *mockArmResourcesListPager) Err() error {
	ret := _m.Called()
...
func (_m *mockArmResourcesListPager) NextPage(ctx context.Context) bool {
	ret := _m.Called(ctx)
...
func (_m *mockArmResourcesListPager) PageResponse() armresources.ResourceGroupsListResponse {
	ret := _m.Called()
